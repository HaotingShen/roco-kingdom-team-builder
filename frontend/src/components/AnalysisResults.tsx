...
// StatRow has been moved to ./StatRow.tsx so EffectiveStatsPanel can reuse it
// without duplicating the gradient/colorMap. The team-analysis renderer below
// continues to use the same component, identically.
