        ...
        {tabs.map((t) => (
          <button
            ...
            className={`px-3 py-1.5 text-xs sm:text-sm rounded-md transition-colors whitespace-nowrap cursor-pointer ${
              active === t.key
                ? "bg-zinc-200 border border-transparent text-zinc-900 font-semibold"
                : "bg-zinc-50 border border-zinc-200 text-zinc-500 hover:bg-zinc-100 hover:text-zinc-700 hover:border-zinc-300"
            }`}
          >
            {t.label}
          </button>
