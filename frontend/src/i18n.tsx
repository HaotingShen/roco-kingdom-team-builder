...
const ui: Record<Lang, Dict> = {
  en: {
    ...
    feedback: {
      ...
      cat_other: "Other 💬",
      message: "Message *",
      messageHelper: "Specific steps to reproduce, screenshots, or device info help us resolve issues faster.",
      messagePlaceholder: "Describe the issue or suggestion, with steps to reproduce if possible…",
  ...
  zh: {
    ...
    feedback: {
      ...
      cat_other: "其他 💬",
      message: "内容 *",
      messageHelper: "建议提供具体复现步骤、截图或设备信息，以便我们更快定位问题。",
      messagePlaceholder: "请描述您遇到的问题或建议，并尽量提供复现步骤……",
      charMin: "至少 10 个字",
      charCount: "{n}/2000",
      replyEmail: "回复邮箱（可选）",
