...
const ui: Record<Lang, Dict> = {
  en: {
    ...
    saveModal: {
      ...
      guestDisclaimer: "Guest teams expire after 90 days of inactivity.",
    ...
    auth: {
      ...
      usernameRequirements: "Username must be 3-32 characters (letters, numbers, underscores only).",
  ...
  zh: {
    ...
    saveModal: {
      ...
      creatingGuest: "创建中...",
      guestDisclaimer: "访客队伍在90天不活动后过期。",
      haveAccount: "已有账号？",
      loginLink: "登录",
    ...
    auth: {
      ...
      usernameRequirements: "用户名需3-32个字符（仅限字母、数字、下划线）。",
