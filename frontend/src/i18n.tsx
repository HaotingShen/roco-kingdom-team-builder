...
const ui: Record<Lang, Dict> = {
  en: {
    ...
    settings: {
      ...
      confirmEmailDescription: "Enter the verification code sent to your new email address.",
      verificationToken: "Verification Code",
      verificationTokenPlaceholder: "Paste verification code",
    ...
    quota: {
      ...
      analysisLimitReached: "Daily analysis limit reached. Try again tomorrow.",
      anonymous: "Anonymous",
      guest: "Guest",
      free: "Free",
      premium: "Premium",
  ...
  zh: {
    ...
    settings: {
      ...
      confirmEmailDescription: "请输入发送到新邮箱的验证码。",
      verificationToken: "验证码",
      verificationTokenPlaceholder: "粘贴验证码",
      confirmButton: "确认修改",
      confirming: "确认中...",
    ...
    quota: {
      ...
      analysisLimitReached: "今日分析次数已用完。请明天再试。",
      anonymous: "匿名",
      guest: "访客",
      free: "免费",
      premium: "高级",
