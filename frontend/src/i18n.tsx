...
const ui: Record<Lang, Dict> = {
  en: {
    ...
    auth: {
      ...
      resendSuccess: "Verification code sent to your email.",
    ...
    settings: {
      ...
      invalidOrExpiredToken: "Invalid or expired verification code.",
      passwordMismatch: "Passwords do not match.",
  ...
  zh: {
    ...
    settings: {
      ...
      invalidOrExpiredToken: "验证码无效或已过期。",
      passwordMismatch: "两次输入的密码不一致。",
