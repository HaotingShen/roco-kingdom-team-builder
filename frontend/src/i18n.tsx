...
const ui: Record<Lang, Dict> = {
  en: {
    ...
    builder: {
      ...
      incompleteTeamMsg: "Team is incomplete. Fill all 6 slots, team name, and magic item.",
      ...
      saveTeamFirst: "Save the team first to save analysis results",
