...
const ui: Record<Lang, Dict> = {
  en: {
    ...
    builder: {
      ...
      analyzingTip: "Analysis takes about 1-2 minutes. Please do not close or refresh the page. You can freely browse other pages in the meantime and will be redirected back automatically when done. If your results ever disappear unexpectedly, re-analyzing the same team will retrieve them without using your quota.",
  ...
  zh: {
    ...
    builder: {
      ...
      analyzingTip: "分析大约需要 1–2 分钟，请勿关闭或刷新页面。期间可自由浏览其他页面，分析完成后将自动返回。若分析结果异常消失，重新分析同一队伍即可找回结果，且不消耗分析次数。",
