  ...
  return (
    <div className="space-y-3">
      ...
      {(!monsters.data || !displayList.length) ? (
        ...
        <div style={{ height: rowVirt.getTotalSize() + 24, position: "relative", overflow: "clip" }}>
  ...
  return (
    <div className="space-y-3">
      ...
      {(!moves.data || !filtered.length) ? (
        ...
        <div /* wrapper keeps the total scroll height */ style={{ height: rowVirt.getTotalSize() + 24, position: "relative", overflow: "clip" }}>
